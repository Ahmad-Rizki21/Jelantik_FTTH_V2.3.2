                    ...
                    <form action="{{ route('tickets.update', $ticket->id) }}" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="customer"
                                value="{{ old('customer', $ticket->customer ? $ticket->customer->name : '') }}"
                                class="form-control">
                            @error('customer_id')
                            ...
                            <div class="form-group">
                                <label>CUSTOMER</label>
                                <input type="text" name="customer"
                                    value="{{ old('customer', $customer->find($ticket->customer_id)->first()->value('name')) }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="ticket_no" value="{{ old('ticket_no', $ticket->number) }}"
                                class="form-control" readonly>
                        </div>

                        <div class="form-group">
                            <label>REPORTED DATE</label>
                            <input type="datetime-local" name="reporteddate" class="form-control"
                                value="{{ old('reporteddate', $ticket->reporteddate ?? '') }}" readonly>
                            @error('reporteddate')
                                <div class="invalid-feedback" style="display: block">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="detail" cols="30" rows="30" class="form-control" @hasrole('Teknisi')
                                readonly @endhasrole>{{ old('detail', $ticket->problemdetail) }}</textarea>
                            @error('detail')
                                <div class="invalid-feedback" style="display: block">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select-technician @error('technician_id') is-invalid @enderror"
                                name="technician_id">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="resolution" cols="30" rows="30"
                                class="form-control">{{ old('resolution', $ticket->resolution) }}</textarea>
                            @error('resolution')
                                <div class="invalid-feedback" style="display: block">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="datetime-local" name="pendingdate"
                        ...
                        <div class="form-group">
                            ...
                            <input type="datetime-local" name="closeddate"
